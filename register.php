...
$(document).ready(() => {
	$('.footer').animate({height: '20%'}, 1800, () => {
		$('#index-band').fadeIn(700, () => {
			$('#index-option1').fadeIn(700);
		});
	});
...
<div class='body col-12' style='background: #44424a; border-bottom: 0px; height: 75%'>
	...
	<table id='sign-form' style='margin: 0 auto; color: white;'>
		<tr>
			<td> <img src='images/misc/sign-logo.png' id='logo-image'> <br><br> </td>
		</tr>
		<tr>
		...
		<tr>
			<td> 
				<br>
				<input type='image' src='images/misc/sign.png' class='index-images2'> 
			</td>
		</tr>	
	</table>	
	</form>
