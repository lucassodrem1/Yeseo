...
<div class='body col-12'>
	...
	<div class='game col-10'>
		Cemitério <input type='button' value='Voltar' onClick='location.href="hall.php"'><br>
		<hr style='border: 1px solid black'> <br><br>
		<div class='scroll-div'>
		<table border='0' style='margin: 0 auto'>
			<tr>
				<td colspan='2' style='border-bottom: 1px solid black'> Jogadores mortos neste andar </td>
			</tr>
			<tr>
				<td style='border-bottom: 1px solid black'> Nome </td>
				<td style='border-bottom: 1px solid black'> Andar máximo </td>
			</tr>
		<?php
		$sql = "SELECT * FROM `graveyard` WHERE `actual_floor`='".$player->getActualFloor()."'";
		$query = query($sql);
