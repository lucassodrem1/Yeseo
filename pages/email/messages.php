...
<div class='body col-12'>
	...
	<div class='game col-10'>
		...
		<table class='table-for-options' border='0'>
			<tr>
				<td> <input type='button' class='btn btn-success' value='Recebidas' onClick='location.href="messages.php"'> </td>
		...
		<table border='1' class='messages-table'>
			...
			if(mysql_num_rows($query) == 0) {
				echo"
				<tr>
					<td colspan='6'> Você não recebeu nenhuma mensagem. </td>
				</tr>	
				";
			} else {
				while($row = mysql_fetch_assoc($query)) {
					$otherPlayer = new Player($row['sender_id']);
					...
					echo"
						...
						<td> ".$time." </td>
						<td> <input type='button' class='btn btn-primary' value='Ler' onClick='location.href=\"read.php?i=".$row['id']."\"'> </td>
						<td> <input type='button' class='btn btn-danger' value='Deletar' onClick='location.href=\"delete_message.php?i=".$row['id']."\"'> </td>
					</tr>
					";
				}
			}
