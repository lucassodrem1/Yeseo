 			...
 			<div class="higher-scrollable" style='margin: 0 auto;'>
				...
				while($row = mysql_fetch_assoc($query)) {
					...
					<tr>
						...
						<td style='border-bottom: 1px solid black'> ".$friend->getActualFloor()."(".$friend->actualFloorName.") </td>
						<td style='border-bottom: 1px solid black'> <input type='button' class='btn btn-primary' value='Visitar Perfil'> </td>
					</tr>
					";
				}
				?>
