...
<div class='body col-12'>
	...
	<div class='game col-10'>
		...
		<input type='button' class='btn btn-primary' style='float: left; width: 40%' onClick='location.href="equips.php"' value='Equipamentos'>
		<input type='button' class='btn btn-primary' style='float: right; width: 40%' onClick='location.href="items.php"' value='Itens'>
	</div>
</div>
