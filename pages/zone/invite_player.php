...
$sql = "INSERT INTO `messages` (`sender_id`, `receiver_id`, `topic`, `message`, `type`, `time`) VALUES ('".$player->getID()."', '".$friend->getID()."', 'Convite para zona desprotegida.', 'Gostaria de batalhar ao seu lado.', '3', 
		'".date('Y-m-d H:i:s')."')";
query($sql);
