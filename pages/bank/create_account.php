...
//Identificar se player já tem uma conta.
...
function creatingAccount() {
	...
	if(!password) {
		...
		message.innerHTML = '<strong>Aviso!</strong> Sua conta precisa ter uma senha.';
		...
		$.ajax({
			...
			success: function(data) {
				...
				message.innerHTML = 'Sua conta foi aberta com sucesso!';
				document.getElementById('alert-space').appendChild(message);
...
<div class='body col-12'>
	...
	<div class='game col-10'>
		...
		<div class='text-balloon alert alert-info'>
			Você ainda não possui uma conta no banco. Que tal abrir sua própria conta e começar a juntar sua grana? 
		</div>
		<br>
		<img class='npc-image' src='../../images/npcs/bank.gif'>

		<table border='0' style='margin: 0 auto;'>
			<tr>
				<td> Senha da conta: <input id='password' type='password' maxlength="7"> </td>
			</tr>
			<tr>
				<td> <input onClick='creatingAccount()' class="btn btn-success" type='button' value='Abrir uma conta!'> </td>
			</tr>		 
		</table>
		<br><br><br>
